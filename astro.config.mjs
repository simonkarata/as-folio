...
export default defineConfig({
  site: process.env.ASTRO_SITE ?? 'https://simonkarata.github.io', // override via ASTRO_SITE env var or edit directly
  base: process.env.ASTRO_BASE ?? '/as-folio', // override via ASTRO_BASE env var or set '/repo-name' for project pages
  output: 'static',
